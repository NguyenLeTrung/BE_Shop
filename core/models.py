...
class Supplier(models.Model):
    ...
    update_by = models.ForeignKey(User, related_name="update%(app_label)s_%(class)s_related", on_delete=models.PROTECT, null=True)
...
class Product_Detail(models.Model):
    product = models.ForeignKey(Product, related_name="product%(app_label)s_%(class)s_related", on_delete=models.CASCADE, null=True)
    size = models.CharField(max_length=10)
    color = models.CharField(max_length=10)


class Ticket_import(models.Model):
    supplier = models.ForeignKey(Supplier, related_name="supplier%(app_label)s_%(class)s_related", on_delete=models.PROTECT, null=True)
...
class Ticket_Import_Detail(models.Model):
    ticket_import = models.ForeignKey(Ticket_import, related_name="ticketimport%(app_label)s_%(class)s_related", on_delete=models.CASCADE, null=True)
    product = models.ForeignKey(Product, related_name="product%(app_label)s_%(class)s_related", on_delete=models.CASCADE, null=True)
    quantity = models.IntegerField(null=True)
    
class Orders(models.Model):
    order_code = models.CharField(max_length=100)
    customer_name = models.ForeignKey(User, related_name="customername%(app_label)s_%(class)s_related", on_delete=models.PROTECT, null=True)
    phone = models.CharField(max_length=20)
    email = models.CharField(max_length=255, null=True)
    address = models.CharField(max_length=255)
...
class Orders_Item(models.Model):
    order = models.ForeignKey(Orders, related_name="order%(app_label)s_%(class)s_related", on_delete=models.PROTECT, null=True)
    product = models.ForeignKey(Product, related_name="product%(app_label)s_%(class)s_related", on_delete=models.PROTECT, null=True)
